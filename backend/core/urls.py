...
from .views import (
    ...
    active_users_count, available_desks_count, desks_in_use_count, active_users_by_department
)
...
urlpatterns = [
    ...
    path('dashboard/active-users-by-department/', active_users_by_department, name='dashboard_active_users_by_department'),
]